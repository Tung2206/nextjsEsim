...
const Header = () => {
    ...
    return (
        <header className={styles.esimokHeader}>
            <div className="container">
                <div className="row">
                    <div className="col-10 col-md-9 col-lg-3">
                        <Link href="/">
                    ...
                    <div className="col-2 col-md-3 col-lg-9">
                        <div className={styles.esimok_menu_header}>
                            <ul>
                                <li> <Link href='/'>Blog</Link> </li>
                                <li> <Link href='/about'>About us</Link> </li>
                            </ul>
                            <button className={styles.btn_header_esimok} >
                               <span> USD ($) </span> <img src="../currency_exchange.png" alt="" />
                            </button>
                        </div>
                        <div className={styles.esimok_menu_header_mobie}>
                            <a className={styles.esimok_menu_bar} data-bs-toggle="offcanvas" href="#offcanvasRight" role="button" aria-controls="offcanvasRight">
                                
                            </a>
                            <div className={`${styles.esimok_canvasMenu} offcanvas offcanvas-end`} tabindex="0" id="offcanvasRight" aria-labelledby="offcanvasRight">
                                <Link href="/" className='mb-3'>
                                    
                                </Link>
                                <ul className={styles.esimok_itemMenu}>
                                    <li> <Link href='/'>Blog</Link> </li>
                                    <li> <Link href='/about'>About us</Link> </li>
                                </ul>
                                <button className={styles.btn_header_esimok} >
